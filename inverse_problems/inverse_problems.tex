...
In particular, we consider three/four models.

\paragraph{The homogeneous well-separated model.}
%This problem can be conveniently posed as  \emph{blind deconvolution}.
...
\paragraph{The homogeneous Poisson model.}
In this model, we assume that the support signal $s$ is generated by a Poisson process. Bla bla bla. While this model is very different from the well-separated model, in Section~\ref{sec:support} we show that TKTK 
...
\paragraph{The heterogeneous Poisson model?.}
