...
By employing autocorrelation analysis, we show that the impossibility to detect and cluster signals' occurrences in high noise levels does not necessarily impose limitations on signal estimation.
