...
We assume that molecule is real-valued and smooth. In spherical coordinates, its 3-D Fourier transform $\widehat\phi$ admits a finite expansion of the form  \TODO{Is it a problem that both our Fourier coordinates and angular frequencies for prolates are called $k$?}
