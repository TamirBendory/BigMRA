...
The authors  thank Ayelet Heimowitz, Joe Kileel,  Roy Lederman, Amit Moscovich and Nir Sharon for helpful discussions, and Fred Sigworth for supplying us with the dataset of the BPTI molecule. The research was partially supported by Award Number R01GM090200 from the NIGMS, FA9550-17-1-0291 from AFOSR, Simons Foundation Math+X Investigator Award, and the Moore Foundation Data-Driven Discovery Investigator Award.\revised{Amit: to verify.} NB is partially supported by NSF award DMS-1719558.
\TODO{Correct bib}
...
this is necessary to  determine the volume.
