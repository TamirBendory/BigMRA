...
\begin{proposition} \label{prop:gamma_sigma}
	...
	Assume $L \geq 3$. % Added by Nicolas, Sep 4, 2018: I checked all identities for L >= 3, with some computer code; I didn't write code to verify the corner cases L = 1 and L = 2.
	The observed autocorrelations $a_y^1,a_y^2$ and  $a_y^3$ determine the ratio $\gamma$ and noise level $\sigma$ uniquely for a generic signal $x$. If $\gamma > \frac{1}{4}$, then this holds for any signal $x$ with nonzero mean. 
	\begin{proof}
