...
\begin{figure}[h]
	...
	\begin{subfigure}[h]{0.45\textwidth}
		...
		\caption{TPRV1}\label{fig:TRPV1_recon}
	\end{subfigure}
	\hfill
	\begin{subfigure}[h]{0.45\textwidth}
		\centering
		\includegraphics[angle=270, width=.7\textwidth]{BPTI_maxL2_L20.eps}
		\caption{BPTI}\label{fig:BPTI_recon}
	\end{subfigure} 
	\caption{\label{fig:cryo_recon} Reconstructions from the first 3 autocorrelations. The reconstruction is shown in gray while the ground truth is shown in yellow.}
\end{figure}
