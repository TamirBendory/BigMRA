...
\begin{figure*}[h]
	...
	\begin{subfigure}[h]{0.24\linewidth}
		\centering
		\includegraphics[width=1.1\linewidth]{Einstien_progress_1}
		\caption{$2\times 10^2$ micrographs}
	\end{subfigure} \hfill
	\begin{subfigure}[h]{0.24\linewidth}
		\centering
		\includegraphics[width=1.1\linewidth]{Einstien_progress_4}
		\caption{$2\times 10^3$ micrographs}
	\end{subfigure} \hfill
	\begin{subfigure}[h]{0.24\linewidth}
		\centering
		\includegraphics[width=1.1\linewidth]{Einstien_progress_40}
		\caption{$2\times 10^4$ micrographs}
	\end{subfigure} \hfill
	\begin{subfigure}[h]{0.24\linewidth}
		\centering
		\includegraphics[width=1.1\linewidth]{Einstien_progress_400}
