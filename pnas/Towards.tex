...
Because likelihood methods are computationally expensive, methods based on recovery from moments have also been previously used for system identification. Methods based on the third- and fourth-order moments are described and analyzed in~\cite{lii1982deconvolution,giannakis1989identification,tugnait1984identification}. Following this approach, in the next section we present an autocorrelation analysis for~\eqref{eq:model} and analyze it in Section~\ref{sec:theory}.  
