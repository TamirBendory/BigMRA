...
\TODO{moments approach + announce the results}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[h]{0.33\textwidth}
		...
		\caption{$\sigma = 3$}
	\end{subfigure}
	\caption{\label{fig:micro_example} Example of data sequences (micrographs) of size $250\times 250$ with additive i.i.d.\ Gaussian noise with variance $\sigma^2$. Each micrograph contains four occurrences of a $50 \times 50$ image of Einstein. Figure~\ref{fig:micro_example} shows a simple example of our problem with  one signal ($K=1$). 
