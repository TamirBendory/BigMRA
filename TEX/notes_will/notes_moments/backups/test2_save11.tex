...
%
    M_2(\Delta,Y) = 
    \begin{cases}
        R_2(\Delta), &\text{ if } \Delta > 0; \\
        R_2(\Delta) + \sigma^2, &\text{ if } \Delta = 0.
    \end{cases}
%
\end{align}
...
Again, the idea is to break up the big average into a fixed number of averages of $\approx n$ independent terms. We can write:
%
\begin{align}
%
    M_3(\Delta_1,\Delta_2) = \sum
%
\end{align}
