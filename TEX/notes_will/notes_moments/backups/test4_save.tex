...
It turns out that $\beta$ satisfies two independent quadratic equations, defined in terms of the observed third-order moments. The previous section gives the equation:
%
\begin{align}
%
    \beta = \frac{A}{B - \sigma^2}.
...
\begin{align}
%
    \beta^2 \cdot (D - BF) + \beta \cdot (AF + BE - C) - AE = 0.
%
\end{align}
